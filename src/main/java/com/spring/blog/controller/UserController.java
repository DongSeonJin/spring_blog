...
import com.spring.blog.config.TokenProvider;
...
public class UserController {
    ...
    public ResponseEntity<?> authenticate(User user){
        ...
        // 유조거 폼에서 날려주는 정보는 id랑 비번인데, 먼저 아이디를 통해 위에서 정보를 얻어오고
        // 비밀번호는 암호화 구문끼리 비교해야 하므로, 이 경우 bCrytEncoder의 match(평문, 암호문) 를 이용하면
