...
public class ReplyController {
    ...
    // http ://localhost:8080/reply/2/all => blogId 파라미터에 2가 전달된것으로 간주한다.
    @RequestMapping(value = "/{blogId}/all", method = RequestMethod.GET)
    // rest서버는 응답시 응답코드와 응답객체를 넘기기 때문에 ResposeEntity<자료형>
    // 을 리턴합니다.
    ...
    public ResponseEntity<?> findReply(@PathVariable long replyId){
        ...
        Reply replyResponseDTO = replyService.findByReplyId(replyId);
