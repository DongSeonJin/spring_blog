...
import com.spring.blog.jwt.JwtProperties;
...
public class TokenProvider {
    ...
    private String makeToken(Date expiry, User user){
        Date now = new Date(); // 현재 시간으로 토큰 발급 날짜 지정할 준비

        return Jwts.builder() // 빌더패턴으로 토큰 생성
                .setHeaderParam(Header.TYPE, Header.JWT_TYPE) // 해더타입은 JWT
